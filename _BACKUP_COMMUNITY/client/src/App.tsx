...
function AppContent() {
  ...
  const isCommunityRoute = location.startsWith("/community");

  return (
    <div className="flex flex-col min-h-screen">
      {!isCommunityRoute && <Header />}
      <main className={isCommunityRoute ? "flex-1" : "flex-1 pt-16 md:pt-20"}>
        <Router />
      </main>
